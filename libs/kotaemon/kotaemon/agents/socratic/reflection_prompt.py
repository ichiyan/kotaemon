...
1. **Structure**
   ...
   - Use **bulleted lists** or **numbered points** when naming examples, strategies, or next steps.
   - Add **line breaks** between ideas for readability.

2. **Tone**
   - Encouraging, mentor-like, but concise.
   - Use **direct second-person (“you”)** phrasing to make it personal.

3. **Length**
   - Keep each section under ~120 words if possible.
